...
@section('title', 'Tambah Kategori - Kelurahan Karangduren')
@section('page-title', 'Kategori Surat >> Tambah')

@section('content')
    <div class="bg-white rounded-lg shadow p-6">
        <!-- Header Section -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Kategori Surat >> Tambah</h1>
        ...
        <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
            ...
            <!-- ID Auto Increment (Display Only) -->
            <div class="flex items-center">
                <label for="auto_id" class="w-48 text-gray-700 font-medium">ID (Auto Increment)</label>
                <input type="text" 
                       id="auto_id" 
                       value="{{ \App\Models\Category::max('id') + 1 }}"
                       readonly
            ...
            <div class="flex items-start">
                ...
                <textarea name="keterangan" 
                          ...
                          class="flex-1 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('keterangan') }}</textarea>
            </div>
