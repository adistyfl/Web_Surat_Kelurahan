...
@section('title', 'Arsipkan Surat - Kelurahan Karangduren')
@section('page-title', 'Arsip Surat >> Unggah')

@section('content')
    <div class="bg-white rounded-lg shadow p-6">
        <!-- Header Section -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Arsip Surat >> Unggah</h1>
